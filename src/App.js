...
import './App.css';
import {Badge, Col, Container, Form, FormControl, Image, Jumbotron, ListGroup, Nav, Navbar, Row,} from "react-bootstrap";
                      ...
                      <Navbar bg="light" expand="md">
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                          <Nav className="mr-auto">
                            ...
                            <Nav.Link href="/cart">Cart <Badge variant="info">{this.props.cart ? this.props.cart.length : 0 }</Badge></Nav.Link>
